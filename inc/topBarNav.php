            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'cab_available'? "active" : '' ?>" href="./?p=cab_available">RIDERS AVAILABLE</a></li>
                ...
                <div>
                  ...
                  <?php else: ?>
                    ...
                    <a href="./driver/login.php" class="text-reset text-decoration-none mx-2"<b>Rider</b></a> |
