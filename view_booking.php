...
<div class="container-fluid">
    <fieldset class="border-bottom">
        <legend class="h5 text-muted"> BODABODA Details</legend>
        <dl>
            <dt class="">BodaBoda Body No</dt>
            <dd class="pl-4"><?= isset($body_no) ? $body_no : "" ?></dd>
            <dt class="">BodaBoda Category</dt>
            <dd class="pl-4"><?= isset($category) ? $category : "" ?></dd>
            <dt class="">BodaBoda model</dt>
            <dd class="pl-4"><?= isset($cab_model) ? $cab_model : "" ?></dd>
            <dt class="">BodaBoda Rider</dt>
            <dd class="pl-4"><?= isset($cab_driver) ? $cab_driver : "" ?></dd>
            <dt class="">BodaBoda Rider Contact</dt>
            <dd class="pl-4"><?= isset($driver_contact) ? $driver_contact : "" ?></dd>
            <dt class="">BodaBoda Address</dt>
