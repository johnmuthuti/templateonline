...
<div class="card card-outline card-info rounded-0">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?>BodaBoda</h3>
	</div>
	<div class="card-body">
		<form action="" id="cab-form">
			...
			<div class="form-group">
				<label for="cab_reg_no" class="control-label">BodaBoda Plate</label>
			...
			<div class="form-group">
				<label for="cab_model" class="control-label">BodaBoda Model</label>
			...
			<div class="form-group">
				<label for="body_no" class="control-label">BodaBoda Body</label>
                <input name="body_no" id="body_no" type="text" class="form-control rounded-0" value="<?php echo isset($body_no) ? $body_no : ''; ?>" required>
			</div>
            <div class="form-group">
				<label for="cab_driver" class="control-label">Rider's Name</label>
			...
			<div class="form-group">
				<label for="driver_contact" class="control-label">Rider's Contact </label>
			...
			<div class="form-group">
				<label for="driver_address" class="control-label">Rider's Address</label>
			...
			<div class="form-group">
				<label for="password" class="control-label">Rider's Account Password</label>
			...
			<div class="form-group col-md-6">
				<label for="" class="control-label">Rider's Image</label>
